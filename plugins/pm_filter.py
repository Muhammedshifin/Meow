...
async def advantage_spoll_choker(bot, query):
    ...
    if int(user) != 0 and query.from_user.id != int(user):
        return await query.answer("ok daa🫦😁 😁𝗛𝗲𝘆 𝗙𝗿𝗶𝗲𝗻𝗱,𝗣𝗹𝗲𝗮𝘀𝗲 𝗦𝗲𝗮𝗿𝗰𝗵 𝗬𝗼𝘂𝗿𝘀𝗲𝗹𝗳.", show_alert=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴀᴜ ꜰɪʟᴛᴇʀ', callback_data='autofilter'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɪɴꜰᴏ', callback_data='pings'),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('sᴏᴜʀᴄᴇ', callback_data='sourcec'),
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐂𝐨𝐝𝐞 𝐛𝐮𝐲 ♥️', url='https://t.me/Master_brooi')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>Hᴇʀᴇ ɪꜱ Fᴏᴜɴᴅ Yᴏᴜʀ Mᴏᴠɪᴇ ✧:{search}\nRᴇǫᴜᴇꜱᴛᴇᴅ Bʏ 𓆩♡︎𓆪: {message.from_user.mention}\nPᴏᴡᴇʀᴇᴅ Bʏ ࿐•: {message.chat.title}</b>"
 
    if imdb and imdb.get('poster'):
        try:
            await message.reply_photo(photo="https://telegra.ph/file/00f09b9e0bc9e8da4b178.jpg", caption=cap[:1024],
                               reply_markup=InlineKeyboardMarkup(btn))
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        k = await msg.reply("<b> ➪ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ɪɴ ᴛʜᴀᴛ ɴᴀᴍᴇ...!</b>😢\n\n<b>➪ ᴄʜᴇᴋ sᴘᴇʟʟɪɴɢ..!</b>\n\n<b>➪ᴛʏᴘᴇ ᴀs ɪɴ ɢᴏᴏɢʟᴇ</b>")
        await asyncio.sleep(8)
        await k.delete()
        return
    ...
    await msg.reply("<b>➪ ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛʜᴀᴛ\nᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ?</b>\n<b>➪ താങ്കൾ ഉദ്ദേശിച്ച മൂവി തായെ വല്ലതും ആണെങ്കിൽ അതിൽ ക്ലിക്ക് ചെയ്യുക...!</b>",
                    reply_markup=InlineKeyboardMarkup(btn))
